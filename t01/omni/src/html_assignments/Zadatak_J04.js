			...
			<div>
				...
				<div>
					<form action="https://cscie12.dce.harvard.edu/echo" method="POST">
						...
						<br />
						<input type="checkbox" name="gluten" /><label for="gluten">Gluten Free Bread</label><br />
						...
						<br />
						<input type="checkbox" name="bubble" /><label for="bubble">Bubble Tea</label><br />
						<input type="checkbox" name="large" /><label for="large">Large Drink</label><br />
