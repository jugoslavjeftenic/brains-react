    ...
    <div>
      ...
      <div className="zad_container">
        ...
        <div>
          ...
          <h1>SEO praksa</h1>
          <p>
            SEO (Search Engine Optimization ) predstavlja marketinsku tehniku koja sa odnosi na optimizaciju sajta za pretrazivace.
            Cilj SEO tehnika je da se sajt prikaze u rezultatima pretrage, sto blize vrhu.
            Najpre moramo da se upoznamo sa nekim <a href="https://sr.wikipedia.org/sr el/SEO_optimalizacija_veb_sajta" target="_blank" rel="noreferrer">osnovnim pojmovima</a>.
          </p>
